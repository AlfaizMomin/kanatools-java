...
public class SingleOpTest extends KanaConverterTester {
  ...
  public void testZenkakuHiraganaToZenkakuKatakana() {
    // Check all target chars
    super.assertConverted(
        KanaConverter.OP_ZEN_HIRA_TO_ZEN_KATA,
  ...
  public void testHankakuKatakanaToZenkakuHiragana() {
    ...
    super.assertConverted(
        KanaConverter.OP_HAN_KATA_TO_ZEN_HIRA, "Aｿｻﾞｻﾞﾞｼﾞｽﾊﾟﾊﾟﾟﾋ1-", "Aそざざ゛じすぱぱ゜ひ1-");
  ...
  public void testZenkakuHiraganaToHankakuKatakana() {
    // Check all target chars
    super.assertConverted(
        KanaConverter.OP_ZEN_HIRA_TO_HAN_KATA,
    ...
    super.assertConverted(
        KanaConverter.OP_ZEN_HIRA_TO_HAN_KATA, "Aそざざ゛じすぱぱ゜ひ1-", "Aｿｻﾞｻﾞﾞｼﾞｽﾊﾟﾊﾟﾟﾋ1-");

    // Check mixed input
    super.assertConverted(
        KanaConverter.OP_ZEN_HIRA_TO_HAN_KATA,
        " !0:A^a|\"　！０：Ａ＾ａ｜＂あがぱゐゔゕゝアガパヰヸヷヵヽ゛｡ｱｶﾞﾊﾟﾞ漢 #1;B_b}\\　＃１；Ｂ＿ｂ｝＼・きじぴゑゖゞキジピヱヹヶヾ゜･ｷｼﾞﾋﾟﾟ字",
        " !0:A^a|\"　！０：Ａ＾ａ｜＂ｱｶﾞﾊﾟｲゔゕゝアガパヰヸヷヵヽﾞ｡ｱｶﾞﾊﾟﾞ漢 #1;B_b}\\"
            + "　＃１；Ｂ＿ｂ｝＼･ｷｼﾞﾋﾟｴゖゞキジピヱヹヶヾﾟ･ｷｼﾞﾋﾟﾟ字");
  }
  ...
  public void testHankakuKatakanaToZenkakuKatakana() {
    // Check all target chars
    super.assertConverted(
        KanaConverter.OP_HAN_KATA_TO_ZEN_KATA,
        "～'｡｢｣､･ｧｨｩｪｫｬｭｮｯｰｱｲｳｴｵｶｷｸｹｺｶﾞｷﾞｸﾞｹﾞｺﾞｻｼｽｾｿｻﾞｼﾞｽﾞｾﾞｿﾞﾀﾁﾂﾃﾄﾀﾞﾁﾞﾂﾞﾃﾞﾄﾞﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾊﾞﾋﾞﾌﾞﾍﾞﾎﾞﾊﾟﾋﾟﾌﾟﾍﾟﾎﾟﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜｦﾝﾞﾟﾡ",
        "～'。「」、・ァィゥェォャュョッーアイウエオカキクケコガギグゲゴサシスセソザジズゼゾタチツテトダヂヅデドナニヌネノハヒフヘホバビブベボパピプペポマミムメモヤユヨラリルレロワヲン゛゜ﾡ");

    // Check logic for collapsing diacritic marks
    super.assertConverted(
        KanaConverter.OP_HAN_KATA_TO_ZEN_KATA, "Aｿｻﾞｻﾞﾞｼﾞｽﾊﾟﾊﾟﾟﾋ1-", "Aソザザ゛ジスパパ゜ヒ1-");
  ...
  public void testZenkakuKatakanaToHankakuKatakana() {
    // Check all target chars
    super.assertConverted(
        KanaConverter.OP_ZEN_KATA_TO_HAN_KATA,
    ...
    // Check logic for affixing diacritic marks
    super.assertConverted(
        KanaConverter.OP_ZEN_KATA_TO_HAN_KATA, "Aソザザ゛ジスパパ゜ヒ1-", "Aｿｻﾞｻﾞﾞｼﾞｽﾊﾟﾊﾟﾟﾋ1-");

    // Check mixed input
    super.assertConverted(
        KanaConverter.OP_ZEN_KATA_TO_HAN_KATA,
        " !0:A^a|\"　！０：Ａ＾ａ｜＂あがぱゐゔゕゝアガパヰヸヷヵヽ゛｡ｱｶﾞﾊﾟﾞ漢 #1;B_b}\\　＃１；Ｂ＿ｂ｝＼・きじぴゑゖゞキジピヱヹヶヾ゜･ｷｼﾞﾋﾟﾟ字",
        " !0:A^a|\"　！０：Ａ＾ａ｜＂あがぱゐゔゕゝｱｶﾞﾊﾟｲヸヷヵヽﾞ｡ｱｶﾞﾊﾟﾞ漢 #1;B_b}\\"
            + "　＃１；Ｂ＿ｂ｝＼･きじぴゑゖゞｷｼﾞﾋﾟｴヹヶヾﾟ･ｷｼﾞﾋﾟﾟ字");
  }
  ...
  public void testHankakuNumberToZenkakuNumber() {
    // Check all target chars
    super.assertConverted(
        KanaConverter.OP_HAN_NUMBER_TO_ZEN_NUMBER, "/0123456789:", "/０１２３４５６７８９:");
  ...
  public void testZenkakuNumberToHankakuNumber() {
    // Check all target chars
    super.assertConverted(
        KanaConverter.OP_ZEN_NUMBER_TO_HAN_NUMBER, "／０１２３４５６７８９：", "／0123456789：");
  ...
  public void testZenkakuSpaceToHankakuSpace() {
    ...
    String trimmed_test =
        KanaConverter.convertKana("　テスト　　", KanaConverter.OP_ZEN_SPACE_TO_HAN_SPACE).trim();
  ...
  public void testCollapseHankakuMarkOnly() {
    ...
    super.assertConverted(
        KanaConverter.OP_KEEP_DIACRITIC_MARKS_APART,
        "～'｡｢｣､･ｧｨｩｪｫｬｭｮｯｰｱｲｳｴｵｶｷｸｹｺｶﾞｷﾞｸﾞｹﾞｺﾞｻｼｽｾｿｻﾞｼﾞｽﾞｾﾞｿﾞﾀﾁﾂﾃﾄﾀﾞﾁﾞﾂﾞﾃﾞﾄﾞﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾊﾞﾋﾞﾌﾞﾍﾞﾎﾞﾊﾟﾋﾟﾌﾟﾍﾟﾎﾟﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜｦﾝﾞﾟﾡ",
        "～'｡｢｣､･ｧｨｩｪｫｬｭｮｯｰｱｲｳｴｵｶｷｸｹｺｶﾞｷﾞｸﾞｹﾞｺﾞｻｼｽｾｿｻﾞｼﾞｽﾞｾﾞｿﾞﾀﾁﾂﾃﾄﾀﾞﾁﾞﾂﾞﾃﾞﾄﾞﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾊﾞﾋﾞﾌﾞﾍﾞﾎﾞﾊﾟﾋﾟﾌﾟﾍﾟﾎﾟﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜｦﾝﾞﾟﾡ");
