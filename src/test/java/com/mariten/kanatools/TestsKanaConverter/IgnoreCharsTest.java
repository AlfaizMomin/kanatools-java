...
public class IgnoreCharsTest extends KanaConverterTester {
  ...
  public void testAsciiIgnoreChars() {
    ...
    super.assertConvertedWithExclusions(
  ...
  public void testKanaIgnoreChars() {
    ...
    super.assertConvertedWithExclusions(
        ...
        "〶 | ぁあぃいぅうぇえぉおかがきぎくぐけげこごさざしじすずせぜそぞただちぢっつづてでとどなにぬねのはばぱひびぴふぶぷへべぺほぼぽまみむめもゃやゅゆょよらりるれろゎわゐゑをん |"
            + " ゔゕゖゝゞ",
        "〶 | ァあィイゥウェエォオカがキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモャヤュユョヨラリルレロヮワゐゑヲン |"
            + " ゔゕゖゝゞ");
  }
  ...
  public void testIgnoreCharsWithNoMatches() {
    ...
    super.assertConvertedWithExclusions(conv_ops, chars_to_exclude, "トウキョウトＡＢＣ", "とうきょうとABC");

    // Ignore list is empty string
    super.assertConvertedWithExclusions(conv_ops, "", "トウキョウトＡＢＣ", "とうきょうとABC");
  }
  // }}}
}
